...
import {BaseCustomComponentDirective} from '../component/base-custom-component.directive';
...
@Directive()
export class DynamicFieldDirective extends BaseCustomComponentDirective implements OnInit {
